...
| -------------------- | ------------------------------------------------------------------ | ------------- | ---------------------------- | ----------------- | -------------------------------------------------------------- |
| auth/login         | Login to dancord via unique username, password                   | POST        | Auth                       | Token           | 403: Invalid credentials                                     |
| auth/register      | Register into dancord via unique username, password              | POST        | Auth                       | Token           | 400: Username/Email is already taken OR password is too weak |
...
| server/list        | Returns a list of ids pertaining to all servers the user is in   | GET         |                            | IdList          |                                                              |
| server/details     | Get the details for a server                                     | GET         | Id                         | ServerDetails   | 400: Invalid ServerId                                        |
| server/join        | Join a server using a unique join id                             | POST        | Id                         |                 | 400: Invalid Join Id                                         |
