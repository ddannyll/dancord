    ...
    return (
        <div className="w-screen h-screen text-zinc-400 bg-zinc-700 flex justify-center items-center">
            <form onSubmit={handleSubmit(onSubmit)} className="shadow-md max-w-md w-full flex flex-col gap-2 p-6 bg-zinc-800 rounded">
                ...
                <button className="bg-violet-500 text-violet-50 p-2 rounded mt-5 hover:bg-violet-600 active:bg-violet-700 transition">Register</button>
                <p className="text-sm">Have an account? <Link href={'/register'} className="text-violet-400 hover:underline">Login</Link></p>
            </form>
        </div>
    )
}
